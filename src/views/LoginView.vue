  ...
  <div class="auth__wrapper">
    <div class="auth--card">
      <div class="logo-container">
        ...
        <!-- <p>- Opulent Homes represents the epitome of luxury and extravagance in the real estate market. With a portfolio
          of lavish properties and a commitment to delivering exceptional service, this business caters to the desires
          of discerning buyers and sellers seeking the utmost in elegance and refinement.</p> -->
      </div>
      <h2>Welcome back!</h2>
      ...
      <form class="form" @submit="onSubmit">
        <div class="input-group">
          ...
          <div class="input-container" :class="errors.email ? 'error' : ''">
            <input autocomplete="email" type="email" placeholder="Ex. you@example.com" id="email" v-bind="email" />
          </div>
        ...
        <button v-if="!loading" class="btn atgd fw-700">
          Login Now
          <span class="-icon arrow"><i class="right-arrow-icon"></i></span>
        </button>

...
import AppGraph from "@/components/charts/AppGraph.vue";
import AppDoughnut from "@/components/charts/AppDoughnut.vue";
import AvailableAssets from "./components/AvailableAssets.vue";
